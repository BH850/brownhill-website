...
return ( <main className="site"> <section className="hero"> <div className="glow glow-left" /> <div className="glow glow-right" />
  ...
  <section id="firm" className="section cream">
    <div className="two-col">
      <div>
        ...
        <p>
          BrownHill helps businesses move beyond scattered marketing activity and build stronger systems for market positioning, audience insight, digital visibility, and customer acquisition.
        </p>
        <p>
          We help organizations understand their market, sharpen their message, show up stronger online, and connect brand visibility to measurable growth.
        </p>
      </div>
  ...
  <section className="section white">
    <div className="centered">
      ...
      <p>
        The firm does not treat marketing as disconnected tasks. Each engagement is built around insight, strategy, execution, and measurable improvement.
      </p>
    </div>
  ...
  <section id="services" className="section cream">
    <div className="centered wide">
      ...
      <p>
        BrownHill helps businesses strengthen their market presence through strategy, SEO, social media optimization, brand development, research, advertising, content, analytics, and lead generation. We support the full marketing ecosystem so organizations can be seen more clearly, communicate with more authority, and convert attention into measurable growth.
      </p>
    </div>
  ...
  <section className="section dark">
    <div className="two-col">
      <div>
        ...
        <p>
          Some clients need a complete strategy. Others need a focused improvement in one area. BrownHill can support individual marketing needs while keeping the larger growth picture in view.
        </p>
      </div>
  ...
  <section id="process" className="section white">
    <div className="two-col">
      <div>
        ...
        <p>
          Our Firm's process is designed to reduce guesswork. The firm studies the business, identifies growth gaps, builds strategy, supports execution, and improves performance through ongoing learning.
        </p>
      </div>
  ...
  <section className="section cream">
    <div className="centered wide">
      ...
      <p>
        Our Firm can serve as a strategic advisor, project partner, campaign resource, or ongoing marketing growth firm depending on the client’s stage and needs.
      </p>
    </div>
  ...
  <section className="section white">
    <div className="founder-panel">
      <div>
        ...
        <h2>Michael Hill</h2>
        <p>
          BrownHill Marketing and Media was founded to help businesses compete with stronger strategy, sharper messaging, and more intentional growth systems. As a founder-led firm, BrownHill combines business development thinking, marketing discipline, customer experience insight, research, media strategy, and brand-building execution.
        </p>
        <p>
          The mission is to help serious operators become more visible, more credible, more informed, and better positioned to win in their market.
        </p>
      </div>
  ...
  <section className="section video-section">
    <div className="two-col video-layout">
      <div>
        ...
        <p>
          BrownHill helps organizations move from scattered activity to clear positioning, stronger visibility, smarter campaigns, and measurable growth systems.
        </p>
        <p>
          This video section can feature a short BrownHill brand intro, founder message, service overview, or client-facing marketing explainer.
        </p>
      </div>
  ...
  <section id="contact" className="section contact">
    <div className="two-col">
      <div>
        ...
        <p>
          Use the form to request a strategy consultation. BrownHill will review your goals, current marketing, digital presence, research needs, advertising opportunities, and best path toward stronger visibility and growth.
        </p>
      ...
      >
        ...
        {submitted && (
          <p className="success">
            Thank you. This demo form is ready to connect to BrownHill’s email, CRM, or booking system.
          </p>
        )}
      </form>
    </div>
